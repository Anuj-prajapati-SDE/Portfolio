  ...
  return (
    <section id="about" className="About-section">
      <div className="left_section" ref={leftSectionRef}>
        <h1>
          Hii
          <span ref={handRef} className="hand-emoji">
            {" "}
            👋,
          </span>
        </h1>
        ...
        <div className="signature-svg">
          ...
          >
            ...
            >
              <path
                d="M3930 3865 c-39 -77 -56 -99 -121 -155 -97 -83 -204 -146 -344 -203
...
745 200 173 86 326 236 361 355 29 103 13 108 -36 10z"
                className="svg-elem-1"
              ></path>
              <path
                d="M4348 3863 c-3 -4 -22 -99 -44 -211 l-39 -202 -40 -11 c-66 -17 -248
...
-43 -3 -38 10 16 42 58 295 55 336 -3 38 -7 47 -25 49 -11 2 -23 0 -25 -5z"
                className="svg-elem-2"
              ></path>
              <path
                d="M1997 3685 c-111 -30 -196 -89 -253 -175 -45 -67 -54 -95 -54 -161 0
...
110 -374 137 -509 100z"
                className="svg-elem-3"
              ></path>
              <path
                d="M4485 3570 c-20 -38 -19 -40 9 -40 33 0 50 23 36 49 -15 29 -27 26
-45 -9z"
                className="svg-elem-4"
              ></path>
              <path
                d="M1475 3407 c-33 -51 -150 -356 -250 -652 -24 -71 -66 -188 -92 -260
...
32 45 96 103 164 148 39 26 49 29 47 11z"
                className="svg-elem-5"
              ></path>
              <path
                d="M700 3314 c-55 -11 -168 -70 -155 -82 2 -3 -12 -23 -33 -46 -20 -23
...
-311 -67 -399 64 -91 135 -32 371 117 467 95 61 207 76 303 40z"
                className="svg-elem-6"
              ></path>
              <path
                d="M3542 3298 c-17 -17 -15 -55 5 -62 25 -10 61 29 47 52 -14 22 -36 26
-52 10z"
                className="svg-elem-7"
              ></path>
              <path
                d="M4002 3253 c-16 -21 -35 -55 -42 -76 -15 -48 -22 -44 -11 6 17 73
...
4 -71 -30z"
              ...
              ></path>
              <path
                d="M3806 3211 c-7 -11 -42 -110 -55 -156 -55 -198 -114 -365 -128 -365
...
195 13 206 -12 4 -25 5 -27 0z"
                className="svg-elem-9"
              ></path>
              <path
                d="M2684 3191 c-49 -12 -93 -44 -164 -116 -36 -37 -75 -71 -88 -76 -28
...
10 21 20 36 22 33 3 -2 -3 -21 -12 -40z"
                className="svg-elem-10"
              ></path>
              <path
                d="M3516 3158 c-119 -397 -212 -642 -191 -508 10 65 30 144 76 300 39
...
30 134 30 139 0 14 -60 11 -64 -3z"
                className="svg-elem-11"
              ></path>
              <path
                d="M3123 3028 c-41 -46 -74 -106 -104 -193 -63 -183 -72 -258 -39 -312
...
44 175 70 244 106 274 24 19 26 25 14 30 -29 11 -50 6 -71 -16z"
                className="svg-elem-12"
              ></path>
              <path
                d="M2904 2999 c-5 -8 -9 -41 -9 -74 -1 -41 -10 -84 -30 -136 -18 -48
...
6 -12 22 -21 33 -15 18 -19 20 -27 8z"
                className="svg-elem-13"
              ></path>
              <path
                d="M2112 2763 c-5 -10 -14 -38 -21 -63 -68 -233 -114 -376 -144 -439
...
19 -54 -2z"
              ...
              ></path>
              <path
                d="M1746 2650 c-26 -31 -64 -108 -106 -212 -13 -32 -25 -56 -27 -54 -4
...
13 268 55 234 57 248 38 276 -22 33 -57 31 -89 -6z"
                className="svg-elem-15"
              ></path>
              <path
                d="M2615 2599 c-4 -6 -5 -12 -2 -15 2 -3 7 2 10 11 7 17 1 20 -8 4z"
                className="svg-elem-16"
              ></path>
              <path
                d="M4096 2491 c-7 -11 22 -23 35 -15 5 3 7 10 4 15 -8 12 -32 12 -39 0z"
                className="svg-elem-17"
              ></path>
              <path
                d="M3945 2474 c-27 -7 -62 -14 -77 -14 -32 0 -46 -17 -23 -27 10 -3 30
1 45 11 16 9 62 19 104 23 42 3 76 10 76 14 0 13 -68 9 -125 -7z"
                className="svg-elem-18"
              ></path>
              <path
                d="M4198 2483 c7 -3 16 -2 19 1 4 3 -2 6 -13 5 -11 0 -14 -3 -6 -6z"
                className="svg-elem-19"
              ></path>
              <path
                d="M3773 2443 c-7 -2 -13 -9 -13 -15 0 -14 43 -6 48 10 4 12 -12 15 -35
5z"
                className="svg-elem-20"
              ></path>
              <path
                d="M3643 2406 c-73 -26 -93 -41 -41 -32 64 12 138 36 138 46 0 14 -27
10 -97 -14z"
                className="svg-elem-21"
              ></path>
              <path
                d="M3875 2313 c-56 -5 -372 -61 -417 -73 -38 -11 -68 -33 -68 -52 0 -5
6 -8 14 -5 7 3 63 15 122 27 60 12 152 30 204 40 166 33 268 42 400 35 99 -6
123 -5 113 5 -6 7 -31 16 -55 21 -42 8 -234 9 -313 2z"
                className="svg-elem-22"
              ></path>
              <path
                d="M1238 2293 c7 -3 16 -2 19 1 4 3 -2 6 -13 5 -11 0 -14 -3 -6 -6z"
                className="svg-elem-23"
              ></path>
              <path
                d="M4155 2246 c-120 -25 -387 -176 -513 -291 -59 -54 -64 -56 -94 -46
...
127 57 205 74 25 5 66 -3 82 -16z"
                className="svg-elem-24"
              ></path>
              <path
                d="M1950 1789 c-127 -33 -338 -107 -555 -197 -185 -76 -363 -205 -411
...
-49 11 -135 -11z"
              ...
              ></path>
              <path
                d="M2405 1535 c-209 -62 -459 -217 -511 -316 -26 -52 -14 -52 32 0 102
114 279 222 477 291 43 15 81 31 84 34 10 9 -38 5 -82 -9z"
